  ...
  Future<void> initializeDatabase() async {
    ...
    _database = await openDatabase(
      ...
      onCreate: (db, version) {
        ...
        db.execute(
          'CREATE TABLE user_details(EmpDesignation TEXT, EmpCode TEXT PRIMARY KEY, EmpName TEXT, ReportTo TEXT, is_check INTEGER, Premier_code TEXT,Region TEXT)',
        );
        db.execute(
      ...
      if (isfirst == '1') {
        ...
        return List.generate(maps.length, (i) {
          return UserDetails(
            ...
            Premier_code: maps[i]['Premier_code'] ?? '',
            Region:  maps[i]['Region'] ?? '', // SQLite stores boolean as integers (0 or 1)
          );
        });
      }
      else {
        ...
        return List.generate(maps.length, (i) {
          return UserDetails(
            ...
            isCheck: maps[i]['is_check'] ==
                0, Premier_code: maps[i]['Premier_code'], Region: maps[i]['Region'],
          );
      ...
      if (isfirst == '1') {
        ...
        return List.generate(maps.length, (i) {
          return UserDetails(
            ...
            empName: maps[i]['EmpName'],
            reportingTo: maps[i]['ReportTo'],
            isCheck: maps[i]['is_check'] == 0, Premier_code: maps[i]['Premier_code'], Region: maps[i]['Region'], // SQLite stores boolean as integers (0 or 1)
          );
        });
      }
      else {
        ...
        return List.generate(maps.length, (i) {
          return UserDetails(
            ...
            reportingTo: maps[i]['ReportTo'],
            isCheck: maps[i]['is_check'] ==
                0, Premier_code: maps[i]['Premier_code'], Region: maps[i]['Region'], // SQLite stores boolean as integers (0 or 1)
          );
        }
        );
      }
...
////////////////////////////////////////////team//////////////////////////////
  ...
  Future<void> fetchbranchapi() async  {
    ...
    try {
      final List<Branch_compnay> value = await branchcom.team_company_fetchData();
