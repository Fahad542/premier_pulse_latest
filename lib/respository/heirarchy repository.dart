...
class HeirarchyRepository {
  ...
  Future<List<UserDetails>> fetchUserDetails() async {
    ...
    final authCredentials = AuthCredentials('XyjKnUk', 'Python@123@');
    try {
        ...
        if (response.statusCode == 200) {
          ...
          List<UserDetails> userDetailsList = userDetailsJsonList.map<
            ...
            return UserDetails(
              ...
              isCheck: data['is_check'] == 'False' ? false : true, Premier_code: data['Premier_code'], Region: data['Region'],
            );
          }).toList();
