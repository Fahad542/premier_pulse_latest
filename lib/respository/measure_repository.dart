...
class measure_repository {
  ...
  Future<Database> database() async {
    return openDatabase(
      ...
      // When the database is first created, create a table to store measures.
      onCreate: (db, version) {
        return db.execute(
      ...
      // Set the version. This executes the onCreate function above when the database is opened for the first time.
      version: 1,
    );
  }
